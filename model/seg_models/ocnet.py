...
__all__ = ['get_ocnet', 'get_ocnet_asp_resnet101_voc', 'get_ocnet_base_resnet101_voc',
           'get_ocnet_base_resnet101_citys']
...
def get_ocnet_base_resnet101_voc(**kwargs):
    return get_ocnet('pascal_voc', 'resnet101', 'base', **kwargs)


def get_ocnet_asp_resnet101_voc(**kwargs):
    return get_ocnet('pascal_voc', 'resnet101', 'asp', **kwargs)


def get_ocnet_base_resnet101_citys(**kwargs):
